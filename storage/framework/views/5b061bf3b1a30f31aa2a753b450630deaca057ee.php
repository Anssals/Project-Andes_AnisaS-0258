    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <?php endif; ?>
                <a class="navbar-brand" href="<?php echo e(route('userHome')); ?>"><?php echo e($brand_title->value ?? 'ZIE ROYALE ESTATE'); ?></a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('show_purpose', 'pg')); ?>">Paying Guest</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
...
<?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>