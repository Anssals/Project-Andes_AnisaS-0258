                ...
                <div aria-label="breadcrumb mt-5">
                    <ol class="breadcrumb">
                        ...
                        <div class="d-flex ms-auto">
                            <a class="btn btn-primary" href="<?php echo e(route('add_category')); ?>">Add</a>
                        </div>
                    </ol>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <th scope="row"><img height="40rem" class="rounded" style="cursor: pointer"
                                        ...
                                        src="<?php echo e(asset('/storage/images/' . $item->image)); ?>" alt="Error"></th>
                                <th scope="row">
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/AdminPanel/category/list.blade.php ENDPATH**/ ?>