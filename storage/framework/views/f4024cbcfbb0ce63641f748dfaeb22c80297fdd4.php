                            ...
                            <tr>
                                ...
                                <th scope="row">
                                    <select class="form-control type" id="<?php echo e($item->id); ?>"
                                        ...
                                        <option <?php if($item->type == 'A'): ?> selected <?php endif; ?> value="A">Admin</option>
                                        <option <?php if($item->type == 'U'): ?> selected <?php endif; ?> value="U">User</option>
                                    </select>
                                </th>
                                <?php if(session()->get('AdminUser')['type'] == 'R'): ?>
                                    <th scope="row">
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/AdminPanel/users/list.blade.php ENDPATH**/ ?>