                ...
                <div aria-label="breadcrumb mt-5">
                    <ol class="breadcrumb">
                        ...
                        <div class="d-flex ms-auto">
                            <a class="btn btn-primary" href="<?php echo e(route('add_facilities')); ?>">Add</a>
                        </div>
                    </ol>
                </div>
            </div>
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/AdminPanel/facilities/list.blade.php ENDPATH**/ ?>