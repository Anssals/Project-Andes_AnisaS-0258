            ...
            <div class="mt-4 ">
                ...
                <div aria-label="breadcrumb mt-5">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php if(!empty($city)): ?>Edit <?php else: ?> Add <?php endif; ?></li>
            ...
            <div class="mt-4">
                <div class="card" style="width:90%;">
                    <div class="card-header">
                        <h4 class=""><?php if(!empty($city)): ?>Edit <?php else: ?> Add <?php endif; ?> City</h4>
                    </div>
                    <div class="card-body">
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="col-12">
                                <button class="btn <?php if(!empty($city)): ?> btn-success <?php else: ?> btn-primary <?php endif; ?>" type="submit"><?php if(!empty($city)): ?> Update <?php else: ?> Submit <?php endif; ?></button>
                            </div>
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/AdminPanel/cities/form.blade.php ENDPATH**/ ?>