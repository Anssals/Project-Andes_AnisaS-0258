...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Welcome back to ZIE ROYALE ESTATE</h1>
            <p class="col-lg-10 fs-4">
                Find your property with us. 
				Remember property, remember us
            </p>
        </div>
...
<?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/User/UserLogIn.blade.php ENDPATH**/ ?>