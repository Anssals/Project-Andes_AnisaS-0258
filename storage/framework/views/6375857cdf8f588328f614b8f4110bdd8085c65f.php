...
<div class="container">
    <footer class="footer mt-auto py-5">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col my-auto">
                        <a class="text-muted btn p-0" href="<?php echo e(route('userHome')); ?>">
                            <h4><?php echo e($brand_title->value ?? 'ZIE ROYALE ESTATE'); ?></h4>
                        </a>
                    </div>
                </div>
                <div class="mb-3">
        ...
        <div class="d-flex justify-content-between py-4 my-4 border-top">
            <p><?php echo e($footer_content->value ?? '© 2022 Company, Inc. All rights reserved. Made with Love <3 sals'); ?></p>
...
<?php /**PATH D:\Anisa\Semester 3\ANDES\RealEstate\Real_Estate_Site\resources\views/layouts/footer.blade.php ENDPATH**/ ?>